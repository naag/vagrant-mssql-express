...
A Windows Server 2008 R2 SP1 VM with SQL Server Express 2012 powered by Vagrant. This is a fork of [fgrehm/vagrant-mssql-express](https://github.com/fgrehm/vagrant-mssql-express), with the difference that it uses SQL Server Express 2012 instead of 2008.
...
* The box has been created with [packer.io](http://www.packer.io/) using the
  templates made available [here](https://vagrantcloud.com/ferventcoder/boxes/win2008r2-x64-nocm).

## Usage

```sh
git clone https://github.com/naag/vagrant-mssql-express.git
